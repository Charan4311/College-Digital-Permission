    ...
    <DashboardLayout>
      ...
      <div className="card" style={{ maxWidth: '1180px', borderRadius: '18px', border: '1px solid #e2e8f0', boxShadow: '0 18px 45px rgba(15, 23, 42, 0.05)', overflow: 'hidden' }}>
        <div className="grid grid-cols-1 md:grid-cols-[minmax(280px,320px)_1fr] gap-0">
          <aside style={{ background: '#ffffff', borderRight: '1px solid #e2e8f0', padding: '22px 18px 18px' }}>
            <div style={{ background: 'linear-gradient(135deg, #2563EB 0%, #60a5fa 100%)', borderRadius: '18px 18px 0 0', padding: '20px 16px 18px', minHeight: '220px', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <main style={{ background: '#f8fafc', padding: '22px 22px 18px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <section style={{ background: 'rgba(255,255,255,0.86)', border: '1px solid #e2e8f0', borderRadius: '16px', padding: '20px 20px 18px' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-[18px] gap-y-[16px]">
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '6px', fontSize: '13px', fontWeight: 700, color: '#0f172a' }}>Roll Number / Username *</label>
            ...
            <section style={{ background: 'rgba(255,255,255,0.86)', border: '1px solid #e2e8f0', borderRadius: '16px', padding: '20px 20px 18px' }}>
              ...
              <form onSubmit={handlePasswordSubmit}>
                ...
                <div style={{ marginTop: '18px', padding: '14px 16px', borderRadius: '12px', background: '#eff6ff', border: '1px solid #bfdbfe', color: '#3B82F6', fontSize: '13px', lineHeight: '1.5' }}>
                ...
                <div style={{ marginTop: '18px', display: 'flex', justifyContent: 'flex-end' }}>
                  <button type="submit" disabled={savingPassword} style={{ background: '#2563EB', color: '#fff', border: 'none', borderRadius: '10px', padding: '12px 18px', fontSize: '13px', fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: '8px', cursor: 'pointer', boxShadow: '0 8px 18px rgba(109,40,217,0.18)' }}>
                    <Lock size={15} />
